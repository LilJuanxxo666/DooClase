...
public final class VersionDTO {
	...
	public VersionDTO(UUID identificador, PublicacionDTO publicacion, VersionDTO versionAnterior, byte numeroVersion,
	...
	public final VersionDTO setNumeroVersion(final byte numeroVersion) {
