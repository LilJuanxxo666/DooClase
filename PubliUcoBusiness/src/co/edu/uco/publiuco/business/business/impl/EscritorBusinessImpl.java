...
public final class EscritorBusinessImpl implements EscritorBusiness {
	...
	@Override
	public void register(final EscritorDomain domain) {
	...
	@Override
	public List<EscritorDomain> list(final EscritorDomain domain) {
		final EscritorEntity entity = EscritorAssembler.getInstance().toEntityFromDomain(domain);
	...
	@Override
	public void modify(final EscritorDomain domain) {
		final EscritorEntity entity = EscritorAssembler.getInstance().toEntityFromDomain(domain);
	...
	@Override
	public void drop(final EscritorDomain domain) {
		final EscritorEntity entity = EscritorAssembler.getInstance().toEntityFromDomain(domain);
