...
public final class PublicacionBusinessImpl implements PublicacionBusiness {
	...
	@Override
	public void register(final PublicacionDomain domain) {
	...
	@Override
	public List<PublicacionDomain> list(final PublicacionDomain domain) {
		final PublicacionEntity entity = PublicacionAssembler.getInstance().toEntityFromDomain(domain);
	...
	@Override
	public void modify(final PublicacionDomain domain) {
		final PublicacionEntity entity = PublicacionAssembler.getInstance().toEntityFromDomain(domain);
	...
	@Override
	public void drop(final PublicacionDomain domain) {
		final PublicacionEntity entity = PublicacionAssembler.getInstance().toEntityFromDomain(domain);
