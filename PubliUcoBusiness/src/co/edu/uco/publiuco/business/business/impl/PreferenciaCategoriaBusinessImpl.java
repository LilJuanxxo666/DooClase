...
public final class PreferenciaCategoriaBusinessImpl implements PreferenciaCategoriaBusiness {
	...
	@Override
	public List<PreferenciaCategoriaDomain> list(final PreferenciaCategoriaDomain domain) {
		final PreferenciaCategoriaEntity entity = PreferenciaCategoriaAssembler.getInstance()
				.toEntityFromDomain(domain);
	...
	@Override
	public void modify(final PreferenciaCategoriaDomain domain) {
		final PreferenciaCategoriaEntity entity = PreferenciaCategoriaAssembler.getInstance()
				.toEntityFromDomain(domain);
	...
	@Override
	public void drop(final PreferenciaCategoriaDomain domain) {
		final PreferenciaCategoriaEntity entity = PreferenciaCategoriaAssembler.getInstance()
				.toEntityFromDomain(domain);
